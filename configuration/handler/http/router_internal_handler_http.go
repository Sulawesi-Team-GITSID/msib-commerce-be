...
func NewGinEngine(credentialHandler *CredentialHandler, profileHandler *ProfileHandler, gameHandler *GameHandler, voucherHandler *VoucherHandler, reviewHandler *ReviewHandler, superAdminHandler *SuperAdminHandler, JWThandler *JWThandler, internalUsername, internalPassword string) *echo.Echo {
	engine := echo.New()
