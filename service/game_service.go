...
type GameUseCase interface {
	...
	GetListGameShop(ctx context.Context, limit, offset string) ([]*entity.GameShop, error)
...
func (svc GameService) GetListGameShop(ctx context.Context, limit, offset string) ([]*entity.GameShop, error) {
	Game, err := svc.GameRepo.GetListGameShop(ctx, limit, offset)
	if err != nil {
		return nil, errors.Wrap(err, "[GameService-GetListGame]")
	}
	return Game, nil
