...
type VoucherUseCase interface {
	...
	GetListVoucherShop(ctx context.Context, limit, offset string) ([]*entity.VoucherShop, error)
...
func (svc VoucherService) GetListVoucherShop(ctx context.Context, limit, offset string) ([]*entity.VoucherShop, error) {
	Voucher, err := svc.VoucherRepo.GetListVoucherShop(ctx, limit, offset)
	if err != nil {
