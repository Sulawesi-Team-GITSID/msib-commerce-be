...
func main() {
	...
	engine := http.NewGinEngine(CredentialHandler, ProfileHandler, GameHandler, VoucherHandler, VerificationHandler, Middlewarehandler, cfg.InternalConfig.Username, cfg.InternalConfig.Password)
